            ...
            {!r2ManualMode ? (
              <>
                <p className="text-[9px] text-muted leading-relaxed">
                  Quét tự động yêu cầu bạn cho phép <b>"Bucket Listing"</b> trong trang quản lý Cloudflare Dashboard (mục R2 Bucket → Settings → Public Sharing).
                </p>
              ...
              <>
                <div className="space-y-1">
                  <label className="block text-[9.5px] font-extrabold uppercase tracking-wider text-secondary/90">
                    Danh sách tên tệp nhạc (Mỗi dòng một tệp)
                  </label>
                  <textarea
                    rows={3}
                    value={r2FilesText}
                  ...
                  <p className="text-[8.5px] text-muted leading-normal">
                    Dán tệp nhạc của bạn (Không cần bật Bucket Listing, phát cực phẩm tức thì!).
                  </p>
                </div>
              ...
              >
                ...
                {r2Status.type === 'err' && !r2ManualMode && (
                  <div className="text-[8.5px] text-muted border-t border-rose-500/10 pt-1 leading-normal font-sans">
                    💡 <b>MẸO</b>: Bạn chỉ cần nhấn vào tab <b>"Dán tên tệp"</b> ở trên cùng, dán danh sách tên file nhạc của bạn vào để nạp ngay mà không cần cấu hình lằng nhằng!
                  </div>
                )}
              </div>
            )}
